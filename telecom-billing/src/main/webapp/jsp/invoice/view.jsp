            ...
            <tbody>
                <c:forEach var="item" items="${invoice.items}">
                    <tr>
                        ...
                        <td class="text-right">${item.unitPrice} EGP</td>
                        <td class="text-right">${item.amount} EGP</td>
                    </tr>
                </c:forEach>
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <th class="text-right">${invoice.subtotal} EGP</th>
                </tr>
                <tr>
                    <th colspan="3" class="text-right">Tax (10%):</th>
                    <th class="text-right">${invoice.tax} EGP</th>
                </tr>
                <tr>
                    <th colspan="3" class="text-right">Total:</th>
                    <th class="text-right">${invoice.total} EGP</th>
                </tr>
            </tfoot>
        </table>
    </div>
