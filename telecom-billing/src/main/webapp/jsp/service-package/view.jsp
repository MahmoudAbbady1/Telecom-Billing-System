        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <dl class="row">
                    ...
                    <dt class="col-sm-4">Is Free Unite : </dt>
...
<script>
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // Display free unit status
                $('#freeUnit').text(data.isFreeUnit ? 'Yes' : 'No');

                console.log("isFreeUnit value:", data.isFreeUnit, typeof data.isFreeUnit);
                $('#freeUnit').text(data.isFreeUnit ? 'Yes' : 'No');
    ...
    $('#freeUnit')
            .text(data.isFreeUnit ? 'Yes' : 'No')
            .addClass(data.isFreeUnit ? 'free-unit-yes' : 'free-unit-no');
